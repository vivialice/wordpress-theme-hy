...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('home_blog', 600, 200, true);
  ...
  * adding additional menus to the array. */
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'theme-hackeryou' ),
		'footer' => __( 'Footer Menu', 'theme-hackeryou' )
	) );
	/*
...
function hackeryou_continue_reading_link() {
	return ' <a class="cont" href="'. get_permalink() . '"><div class="contContainer">Read More</div></a>';
}
